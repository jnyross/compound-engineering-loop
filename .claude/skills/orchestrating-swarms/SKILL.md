...
description: Orchestrate multi-agent swarms with Claude Code's TeammateTool and Task system. Use when coordinating parallel agents, pipeline workflows, or task queues.
