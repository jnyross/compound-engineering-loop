---
name: brainstorming
description: Explore user intent, approaches, and design decisions through collaborative dialogue before planning. Use when brainstorming features or when requirements have multiple valid interpretations.
---
