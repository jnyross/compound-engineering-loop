...
description: Write Ruby/Rails code in DHH's 37signals style with REST purity, fat models, thin controllers, and Hotwire patterns. Use when writing Rails code or when DHH/37signals style is requested.
---
