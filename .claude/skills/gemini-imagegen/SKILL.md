...
description: Generate and edit images via Gemini API. Use when creating images from prompts, editing images, applying style transfers, or composing from references.
---
