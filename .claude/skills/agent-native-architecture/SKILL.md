...
description: Build applications where agents are first-class citizens. Use when designing autonomous agents, creating MCP tools, or building apps where features are agent-achieved outcomes.
---
