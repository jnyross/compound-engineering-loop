---
name: file-todos
description: Manage file-based todo tracking in the todos/ directory. Use when creating todos, managing status/dependencies, triaging, or integrating with code review.
