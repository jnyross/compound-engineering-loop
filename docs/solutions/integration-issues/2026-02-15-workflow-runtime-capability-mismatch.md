...
- **Follow-up fixes:** [Antfarm Workflow P2/P3 Review Findings](../logic-errors/2026-02-15-antfarm-workflow-review-findings.md)—resolved todos 016-020 (single-line constraints, decision gate, label naming, stale context, simplifications)
